...
/**
 * Ce programme affiche - un message Hello personnalisé si un argument a été
 * envoyé lors de l'exécution du programme - le message traditionnel "Hello
 * World!" si ce n'est pas le cas
 * 
